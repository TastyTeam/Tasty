...
<body>
<form class="form-inline definewidth m20" action="searchuser" method="post">    
    用户名称：
    <input  placeholder="phone" type="text" name="sphone" id="username"class="abc input-default"  value="">&nbsp;&nbsp;  
