...
function addcommunities(id,count){
	location.href = "communities?communitiesid=" + id+"&content="+document.getElementById("content").value;
}
</script>
<style>
	.container{
...
<div class="container">
	<div class="commentbox">
		...
		<div class="btn btn-info pull-right" id="comment" onclick="addcommunities(2,${content});" >评论</div>
	</div>
